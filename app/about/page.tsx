...
const LEADERSHIP = [
  {
    name: "Tony Odoh",
    role: "Founder & CEO",
    bio: "Mass Communicator, Cybersecurity Analyst, and Entrepreneur. Tony leads ShopPay NG's vision to make online commerce safe and accessible for every Nigerian.",
    image: "/WhatsApp%20Image%202026-02-15%20at%2010.51.51.jpeg",
  },
  {
    name: "Timilehin Ogunnowo",
    role: "Chief Technology Officer",
    bio: "Timilehin drives product and technology strategy, ensuring ShopPay NG remains secure, fast, and reliable for buyers and sellers.",
  ...
  },
  {
    ...
    bio: "Josephine oversees operations and governance, keeping ShopPay NG compliant and running smoothly for our users and partners.",
    image: "/WhatsApp%20Image%202026-02-15%20at%2010.16.33.jpeg",
  },
  {
    name: "David Dean",
    role: "Social Media Manager / Head of Marketing",
    bio: "David leads brand and growth across social channels, helping more Nigerians discover and trust ShopPay NG.",
    image: null,
  },
];

export const metadata = {
  title: "About – ShopPay NG Nigeria",
    ...
    <div className="bg-[var(--background)]">
      ...
      <section className="border-t border-[var(--border)] bg-[var(--tint-pink)]/50 px-4 py-10 sm:px-6 sm:py-12">
        <AnimateIn>
          ...
          <h2 className="text-xl font-bold text-[var(--text-primary)]">Get the ShopPay NG app</h2>
